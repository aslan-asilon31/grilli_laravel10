...
<head>
  ...
  @livewireStyles
    ...
    <!-- Slick -->
    <link rel="stylesheet" href="{{ asset('cakeadmin-main/libs/slick/slick.css')}}" type="text/css">

    <!-- Main style file -->
    <link rel="stylesheet" href="{{ asset('cakeadmin-main/css/app.css')}}" type="text/css">
    </head>
<body>
<!-- preloader -->
<div class="preloader">
    <img src="{{ asset('frontend/favicon.svg')}}" alt="logo">
        ...
        <div class="dropdown">
            <a href="#" class="d-flex align-items-center" data-bs-toggle="dropdown">
                <div class="avatar me-3">
                    <img src="{{ asset('cakeadmin-main/images/user/man_avatar5.jpg')}}"
...
<div class="layout-wrapper">
    ...
    <a href="./dashboard.html" class="logo">
        <img width="100" src="{{ asset('cakeadmin-main/logo.png')}}" alt="logo">
    </a>
    <!-- ./ Logo -->
                    ...
                    <div class="dropdown-menu-body">
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{ asset('cakeadmin-main/images/products/3.jpg')}}" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Digital clock</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{ asset('cakeadmin-main/images/products/4.jpg')}}" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Toy Car</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{ asset('cakeadmin-main/images/products/5.jpg')}}" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Sunglasses</h6>
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <a href="#" class="me-3 flex-shrink-0 ">
                                    <img src="{{ asset('cakeadmin-main/images/products/6.jpg')}}" class="rounded" width="60"
                                         alt="...">
                                </a>
                                <div>
                                    <h6>Cake</h6>
    ...
    <footer class="content-footer">
        <div><a href="https://grilli.sulaslansetiawan.cfd" target="_blank">Grilli</a> © 2024</div>
    </footer>
    <!-- ./ content-footer -->
...
<!-- JQuery -->
<script src="{{ asset('cakeadmin-main/libs/jquery-3.7.1.min.js')}}"></script>

<!-- Nicescroll -->
<script src="{{ asset('cakeadmin-main/libs/nicescroll.js')}}"></script>

<!-- Apex chart -->
<script src="{{ asset('cakeadmin-main/libs/charts/apex/apexcharts.min.js')}}"></script>

<!-- Slick -->
<script src="{{ asset('cakeadmin-main/libs/slick/slick.min.js')}}"></script>

<!-- Examples -->
<script src="{{ asset('cakeadmin-main/js/examples/dashboard.js')}}"></script>

<!-- Main Javascript file -->
<script src="{{ asset('cakeadmin-main/js/app.js')}}"></script>
